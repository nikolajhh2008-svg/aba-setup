...
# Präsentation und Diskussion üben

Lies `regeln/praesentation.md` und `regeln/beurteilung.md`.

**Warum das kein Zusatz ist:** Sieben der dreizehn Beurteilungskriterien
betreffen die mündlichen Teile. Wer gut schreibt und schlecht präsentiert,
verliert mehr als die Hälfte der Bewertungsgrundlage.

---

## Zwei Betriebsarten

Frag zu Beginn, welche gemeint ist.

### A – Vortrag aufbauen

Der Vortrag ist keine Zusammenfassung der Arbeit. Er beantwortet in wenigen
Minuten: Was war die Frage, warum ist sie interessant, wie bin ich vorgegangen,
was ist herausgekommen, was folgt daraus.
...
Frag nach der verfügbaren Zeit und rechne sie in Abschnitte um. Prüfe die
Gewichtung an den Minuten, nicht an den Folien.
...
3. Genau dort nachhaken, wo die Antwort dünn war – so, wie es eine Kommission
   tut, die den Text gelesen hat.
4. Erst nach mehreren Runden auswerten: an welcher Stelle die Begründung fehlte
   und was im Text steht, das die Antwort getragen hätte.
...
- Nachsichtig sein, weil eine Antwort schwerfällt – eine geschonte Übung ist
  keine Übung
- Die Antwort vorsagen, bevor sie versucht wurde

---

## Am Ende

Nenne die Fragen, bei denen die Antwort noch nicht trug, mit der Stelle in der
Arbeit, die sie hätte tragen können. Das ist der eigentliche Ertrag: nicht die
geübte Antwort, sondern das Wissen, wo im eigenen Text die Antwort steht.

Protokolleintrag vorschlagen.
